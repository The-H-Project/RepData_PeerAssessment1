...
The averages for weekday and weekend are calculated separately, and then stacked together for the graph.
...
# Average 
# ImputedWeekDayOrEndAverages <- ImputedDatawide[, lapply(.SD, mean, .SDcols=2:(ncol(ImputedDatawide)-3)), by=WeekDayOrEnd['Weekday']]
